import { z } from "zod";
import { Difficulty, Duos, GameMapType, GameMode, GameType, PlayerType, Quads, TerrainType, Trios, UnitType, } from "../game/Game";
...
export class DefaultConfig {
    ...
    unitInfo(type) {
        switch (type) {
            ...
            case UnitType.MIRV:
                return {
                    cost: this.costWrapper(() => 35000000, UnitType.MIRV),
                    territoryBound: false,
                };
    ...
    attackLogic(gm, attackTroops, attacker, defender, tileToConquer) {
        ...
        if (attacker.isPlayer() && defender.isPlayer()) {
            ...
            if (attacker.type() === PlayerType.FakeHuman &&
                defender.type() === PlayerType.Bot) {
                mag *= 0.8;
            }
        }
        if (defender.isPlayer()) {
            ...
            return {
                attackerTroopLoss: within(defender.troops() / attackTroops, 0.6, 2) *
                    mag *
                    0.8 *
